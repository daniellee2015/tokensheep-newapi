...
// NormalizeClaudeMessageID re-exports the id helper for host adaptors that
// hand back an Anthropic-shaped response after converting from another format.
func NormalizeClaudeMessageID(id string) string {
	return oaichat.NormalizeClaudeMessageID(id)
}
