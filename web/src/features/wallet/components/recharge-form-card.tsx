...
const PAYMENT_METHOD_SKELETON_KEYS = ['method-a', 'method-b', 'method-c']
...
export function RechargeFormCard({
          ...
          <div className='space-y-4 sm:space-y-6'>
            ...
            <div className='space-y-3'>
              ...
              <div className='grid grid-cols-2 gap-3 sm:grid-cols-4'>
                {PRESET_AMOUNT_SKELETON_KEYS.map((key) => (
  ...
  return (
    ...
    >
                ...
                <div className='space-y-2.5 sm:space-y-3'>
                  ...
                  <div className='grid grid-cols-2 gap-1.5 sm:gap-3 md:grid-cols-4'>
                    {presetAmounts.map((preset) => {
                      ...
                      return (
                        <Button
                          // Include discount in the key so a preset "$10 at
                          // 20% off" and a plain "$10" don't collide when
                          // both appear in the same list.
                          key={`${preset.value}-${preset.discount ?? 'full'}`}
                          variant='outline'
                          className={cn(
                  ...
                  <div className='space-y-2.5 sm:space-y-3'>
                    ...
                    <div className='grid grid-cols-2 gap-1.5 sm:gap-3 lg:grid-cols-3'>
                      {waffoPayMethods?.map((method, index) => {
                        ...
                        const methodKey = [
                          method.name,
                          method.payMethodType || 'auto-type',
                          method.payMethodName || 'auto-name',
                        ].join('-')
      ...
      {/*
        Redemption is intentionally rendered by the standalone RedemptionCard
        at the wallet page level (see features/wallet/index.tsx), not inline
        here. Upstream's inline block was dropped to keep the recharge form
        focused on top-up flows.
      */}
    </TitledCard>
  )
}
