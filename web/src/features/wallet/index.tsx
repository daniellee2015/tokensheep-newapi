...
export function Wallet(props: WalletProps) {
  ...
  const handlePaymentMethodSelect = (method: PaymentMethod) => {
    ...
    // Tokensheep flow: selection alone does not pay. Only clear the alternate
    // Waffo method selection so the two selectors stay mutually exclusive.
    // The upstream flow triggered payment right here — that regressed the
    // "primary Pay button" UX below the card, so we drop it deliberately.
  ...
  return (
    <>
      ...
      <PaymentConfirmDialog
        ...
        usdExchangeRate={effectiveUsdExchangeRate}
        pancakeSurchargePercent={topupInfo?.waffo_pancake_surcharge_percent}
      />
