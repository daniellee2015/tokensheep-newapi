...
const HERO_PROVIDERS: {
  ...
  // .Avatar now requires the full IconAvatarProps (including a required
  // `size`), which doesn't match the `{size?}` shape the row uses. Fall
  // back to the base Kimi mark instead.
