...
const _systemInfoSchema = z.object({
  // Empty SystemName is intentional: operators whose logo already carries a
  // wordmark suppress the redundant text label in header/sidebar/footer.
...
export function SystemInfoSection({ defaultValues }: SystemInfoSectionProps) {
  ...
  const systemInfoSchemaWithI18n = z.object({
    // Same rationale as the outer schema: SystemName is optional so a wordmark
    // logo can stand alone. Match the base schema exactly rather than adding
    // an i18n-branded required-message we would never surface.
    SystemName: z.string().optional().or(z.literal('')),
    ServerAddress: z.string().optional(),
    Logo: z.string().url().optional().or(z.literal('')),
    Footer: z.string().optional(),
