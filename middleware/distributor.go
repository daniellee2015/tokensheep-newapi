			...
			if shouldSelectChannel {
				...
				if channel == nil {
					...
					if err != nil {
						...
						//}
						abortWithOpenAiMessage(c, anthropicModelNotFoundStatus(c), message, types.ErrorCodeModelNotFound)
						return
					}
					if channel == nil {
						abortWithOpenAiMessage(c, anthropicModelNotFoundStatus(c), i18n.T(c, i18n.MsgDistributorNoAvailableChannel, map[string]any{"Group": usingGroup, "Model": modelRequest.Model}), types.ErrorCodeModelNotFound)
						return
					}
				}
			}
...
func SetupContextForSelectedChannel(c *gin.Context, channel *model.Channel, modelName string) *types.NewAPIError {
	...
	common.SetContextKey(c, constant.ContextKeyChannelErrorMaskRules, channel.GetErrorMaskRulesJSON())
